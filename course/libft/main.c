...
// ft_strnstr	
int main(){	char haystack[] = "Hello World";	char needle[] = "World";	size_t haystack_len = 11; 	char *substring = ft_strnstr(haystack, needle, haystack_len); 	if (substring)		printf("Found substring: %s\n", substring);	else		printf("Substring not found\n"); 	return 0;}
// ft_atoi 
// ft_calloc 
// ft_strdup 
// ft_substr 
